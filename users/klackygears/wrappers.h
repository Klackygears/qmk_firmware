...
#define LAYOUT_3x6_3_wrapper(...)            LAYOUT_split_3x6_3(__VA_ARGS__)
...
*/
//Numpad layout with different mod-tap keys for MAC OS and Windows
  #define ______________TD_NUMB_R1___________________       TD(TD_MINPLS), KC_KP_7, KC_KP_8,              KC_KP_9,              KC_COLN
  #define ______________TD_NUMB_R2___________________       TD(TD_DIVMLT), KC_KP_4, KC_KP_5,              KC_KP_6,              C_S_T(KC_SCLN)
  #define ______________TD_NUMB_R3_MAC_______________       TD(TD_DOTEQL), KC_KP_1, MT(MOD_LGUI,KC_KP_2), MT(MOD_LALT,KC_KP_3), MT(MOD_LCTL,KC_KP_0)
  #define ______________TD_NUMB_R3_WIN_______________       TD(TD_DOTEQL), KC_KP_1, MT(MOD_LCTL,KC_KP_2), MT(MOD_LALT,KC_KP_3), MT(MOD_LGUI,KC_KP_0)
...
*/
//Numpad layout with different mod-tap keys for MAC OS and Windows
  #define _________________NUMB_R1___________________       KC_PMNS,       KC_KP_7, KC_KP_8,              KC_KP_9,              KC_COLN
  #define _________________NUMB_R2___________________       KC_PSLS,       KC_KP_4, KC_KP_5,              KC_KP_6,              C_S_T(KC_SCLN)
  #define _________________NUMB_R3_MAC_______________       KC_DOT,        KC_KP_1, MT(MOD_LGUI,KC_KP_2), MT(MOD_LALT,KC_KP_3), MT(MOD_LCTL,KC_KP_0)
  #define _________________NUMB_R3_WIN_______________       KC_DOT,        KC_KP_1, MT(MOD_LCTL,KC_KP_2), MT(MOD_LALT,KC_KP_3), MT(MOD_LGUI,KC_KP_0)
  #define _________________NUMB_R4___________________       KC_LSFT,       KC_KP_0, KC_KP_0,              _______,              _______
  #define _________________NUMB_R1_Game______________       KC_B,          KC_7, KC_8,              KC_9,              KC_COLN
  #define _________________NUMB_R2_Game______________       KC_N,          KC_4, KC_5,              KC_6,              C_S_T(KC_SCLN)
  #define _________________NUMB_R3_Game______________       KC_0,          KC_1, KC_2,              KC_3,              KC_0
...
#define _________________RGB_1_____________________       RGBRST,     UG_HUEU,    UG_SATU,    UG_VALU,    UG_SPDU
#define _________________RGB_2_____________________       UG_NEXT,    UG_HUED,    UG_SATD,    UG_VALD,    UG_SPDD
#else
