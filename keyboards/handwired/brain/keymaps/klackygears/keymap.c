...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WINBASE] = LAYOUT_wrapper(
    ...
    RGB_TOG, _______________DVORAK_L2___________________, PFWD,         KC_GAMR1, _______________DVORAK_R2___________________, RGB_TOG,
  ...
  [_GAMR2] = LAYOUT_wrapper(
    ...
    KC_TAB,  KC_F,    KC_A,    KC_S,    KC_D,    KC_6,      KC_DEL,        KC_GAMR1,   _________________RGB_2_____________________, RGB_TOG,
    KC_O,    KC_I,    KC_2,    KC_Q,    KC_1,    KC_7,        KC_V,        KC_GAMR2,   _________________MEDIA_____________________, RGB_MOD,
             KC_X,    KC_G,             KC_H,    KC_LSFT,  KC_LCTL,        _______,    KC_UP,   KC_V,              KC_TAB, KC_LALT,
                                        KC_Z,    KC_SPC,      KC_Z,        KC_LEFT,    KC_DOWN, KC_RIGHT
  ),
  /*Jedi - Fallen Order
  [_GAMR2] = LAYOUT_wrapper(
