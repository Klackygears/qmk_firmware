...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLBASE] = LAYOUT_wrapper(
             _________________COLEMAK_L1________________, KC_ESC,          KC_GAMER, _________________WINCOLE_R1________________,
    UG_TOGG, _________________COLEMAK_L2________________, _______,         KC_GAMR1, _________________COLEMAK_R2________________, UG_TOGG,
    UG_NEXT, _________________WINCOLE_L3________________, _______,         KC_GAMR2, _________________WINCOLE_R3________________, KC_WINBASE,
             _______, _______,             __________________WIN_THUMB_CLUSTER_V2______________,                _______, _______,
  ...
  [_MACBASE] = LAYOUT_wrapper(
    ...
    UG_TOGG, _______________DVORAK_L2___________________, _______,      _______, _______________DVORAK_R2___________________, UG_TOGG,
    UG_NEXT, _______________MACDVK_L3___________________, _______,      _______, _______________MACDVK_R3___________________, UG_NEXT,
  ...
  [_GAMER] = LAYOUT_wrapper(
    ...
    KC_T,    KC_Q,    KC_A,    KC_S,    KC_D,    KC_3,      KC_I,          KC_GAMR1, _________________RGB_2_____________________, UG_TOGG,
    KC_P,    KC_E, KC_LALT,    KC_Z,    KC_1,    KC_2,      KC_M,          KC_GAMR2, _________________MEDIA_____________________, UG_NEXT,
  ...
  [_GAMR1] = LAYOUT_wrapper(
    ...
    KC_TAB,  KC_V,    KC_A,    KC_S,    KC_D,    KC_2,        KC_L,        KC_GAMR1,   _________________RGB_2_____________________, UG_TOGG,
    KC_T,    KC_I,    KC_F,    KC_Q,    KC_4,    KC_3,        KC_M,        KC_GAMR2,   _________________MEDIA_____________________, UG_NEXT,
  ...
  [_GAMR2] = LAYOUT_wrapper(
    ...
    KC_TAB,  KC_F,    KC_A,    KC_S,    KC_D,    KC_2, LSFT(KC_F2),        KC_GAMR1, _________________RGB_2_____________________, UG_TOGG,
    KC_TAB,  KC_TAB,  KC_X,    KC_Z,    KC_C,    KC_3,        KC_M,        KC_GAMR2, _________________MEDIA_____________________, UG_NEXT,
  ...
  [_SYMB] = LAYOUT_wrapper(
    ...
    UG_NEXT, _________________PUNC_L3_ALT_______________, _______,      _______, _________________PUNC_R3___________________, _______,
             _______, _______,          _______, _______, KC_DEL,       KC_CAPS, _______, KC_SCT1,             _______, _______,
  ...
  [_FUNC] = LAYOUT_wrapper(
    ...
    UG_NEXT, _____________FUNC_L3_______________________,    _______,      _______, _______, _____________FUNC_3_______________, _______,
             _______, _______,          _______, _______,    _______,      KC_CAPS, RSFT_T(KC_ENT), _______,   _______, _______,
                                        _______, _______,    _______,      KC_CAPS, RSFT_T(KC_ENT), _______
  ),
  ...
  [_MNMB] = LAYOUT_wrapper(
    ...
    UG_NEXT, _________________MACNAV_L3_________________, _______,      _______, _________________NUMB_R3_MAC_______________, _______,
  ...
  [_NUMB] = LAYOUT_wrapper(
    ...
    UG_NEXT, _________________WINNAV_L3_________________, _______,      _______, _________________NUMB_R3_WIN_______________, _______,
             _______, _______,          KC_NUM,  _______, _______,      _______, RSFT_T(KC_ENT), KC_RSFT,   KC_NUM,  _______,
                                        _______, _______, _______,      _______, RSFT_T(KC_ENT), KC_RSFT
  ),

   [_MDIA] = LAYOUT_wrapper(
             _________________LYOUT_____________________, _______,      UG_TOGG, _________________RGB_1_____________________,
    _______, _________________KC_BLANK__________________, _______,      _______, _________________RGB_2_____________________, _______,
    UG_NEXT, _________________KC_BLANK__________________, _______,      _______, _________________MEDIA_____________________, _______,
