...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLBASE] = LAYOUT_wrapper(
    ...
    RGB_TOG, _________________COLEMAK_L2________________, _______,         KC_GAMR1, _________________COLEMAK_R2________________, RGB_TOG,
    RGB_MOD, _________________WINCOLE_L3________________, _______,         KC_GAMR2, _________________WINCOLE_R3________________, KC_WINBASE,
             _______, _______,             __________________WIN_THUMB_CLUSTER_V2______________,                _______, _______,
