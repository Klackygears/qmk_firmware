...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                   ENT,  SPSY,  MBNB,     MTNB,  ENSY,    ENT \
                              //`--------------------'  `--------------------'
  ),

  [_NUMB] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
      _____,  PGUP,  PGDN,  HOME,   END,  FNDR,                 MINPLS,     7,     8,     9, COLON, _____,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
  ...
  [_MNMB] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
      _____,  PGUP,  PGDN,  HOME,   END, XXXXX,                 MINPLS,     7,     8,     9, COLON, _____,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____,  LEFT,    UP,  DOWN, RIGHT, XXXXX,                 DIVMLT,     4,     5,     6,  CSTC, _____,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, XXXXX, XXXXX, MCCPY, MCPIN,   DEL,                 DOTEQL,     1,  GUI2,  ALT3,  LCTL, _____,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  _____, _____, _____,    _____, _____,     0 \
                              //`--------------------'  `--------------------'
  ),
