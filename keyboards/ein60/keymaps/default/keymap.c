...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_QWERTY] = LAYOUT( \
     KC_TAB,        KC_Q,   KC_W,    KC_E,    KC_R,  KC_T,   KC_ESC,   KC_Y,   KC_U,  KC_I,    KC_O,    KC_P,    KC_BSPC, \
     ...
     KC_LCTL,       KC_GRV, KC_LGUI, KC_LALT, LOWER, KC_SPC, KC_SPC,   KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
    ),
    /* Lower
     * ,-----------------------------------------.  ,------.  ,-----------------------------------------.
     * | Esc  |   !  |   @  |   #  |   $  |   %  |  |      |  |   ^  |   &  |   *  |   (  |   )  | Del  |
     ...
     */
    [_ADJUST] = LAYOUT( \
     TSKMGR,  _______, _______, _______, _______, _______, _______, _______, RGB_MOD, RGB_VAI, RGB_SAI, RGB_HUI, CALTDEL, \
