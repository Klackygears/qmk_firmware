...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT( \
     ...
     _______, _______,  _______, _______, KC_NO,   KC_BSPC,  _______,  KC_BSPC, KC_NO,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
    /* Raise
     * ,-----------------------------------------.  ,------.  ,-----------------------------------------.
    ...
    [_RAISE] = LAYOUT( \
     ...
     _______, KC_COMM, KC_0,  KC_DOT, KC_NO,  KC_BSPC,  _______,  KC_BSPC, KC_NO,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
    /* Adjust (Lower + Raise)
     * ,-----------------------------------------.  ,------.  ,-----------------------------------------.
    ...
    [_ADJUST] = LAYOUT( \
     ...
     _______, _______, _______, _______, KC_NO,   _______, _______, _______, KC_NO,   _______, _______, _______, RESET
    ),
    /* Function
     * ,-----------------------------------------.  ,------.  ,-----------------------------------------.
     * |      |      |      |      |      |      |  |      |  |      |      |  Up  |      |      |      |
    ...
    [_FUNCTION] = LAYOUT( \
     ...
     _______, _______, _______, _______, KC_NO,   _______, _______, _______, KC_NO,   _______, _______, _______, _______
    )
};
