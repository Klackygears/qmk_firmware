...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLBASE] = LAYOUT_split_4x6_2_wrapper(
      KC_ESC,  _______________DVORAK_L1___________________,   KC_MUTE,  _________________COLEMAK_R1________________, KC_BSPC,
      AU_TOG,  _______________DVORAK_L2___________________,             _________________COLEMAK_R2________________, RGB_TOG,
      CK_TOGG, _______________WINDVK_L3___________________,             _________________COLEMAK_R3________________, RGB_MOD,
      KC_WINBASE,  KC_2, KC_3, ________WIN_THUMB_L______,   KC_SPC,   ________WIN_THUMB_R______, KC_1,  KC_2, KC_GAMER
    ),

    //Borderlands
    [_GAMER] = LAYOUT_split_4x6_2_wrapper(
