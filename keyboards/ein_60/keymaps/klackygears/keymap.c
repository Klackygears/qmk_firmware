...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WINBASE] = LAYOUT_wrapper(
      ...
      AU_TOGG, _______________DVORAK_L2___________________,             _______________DVORAK_R2___________________, UG_TOGG,
      CK_TOGG, _______________WINDVK_L3___________________,             _______________WINDVK_R3___________________, UG_NEXT,
    ...
    [_MACBASE] = LAYOUT_wrapper(
      ...
      UG_TOGG, _______________DVORAK_L2___________________,              _______________DVORAK_R2___________________, UG_TOGG,
      //UG_NEXT, _______________DVORAK_L3___________________,              _______________DVORAK_R3___________________, UG_NEXT,
      UG_NEXT, _______________MACDVK_L3___________________,              _______________MACDVK_R3___________________, UG_NEXT,
    ...
    [_COLBASE] = LAYOUT_wrapper(
      ...
      AU_TOGG, _________________COLEMAK_L2________________,             _________________COLEMAK_R2________________, UG_TOGG,
      CK_TOGG, _________________COLEMAK_L3________________,             _________________COLEMAK_R3________________, UG_NEXT,
      KC_WINBASE,  KC_2,  KC_3,  ________WIN_THUMB_L______,   KC_SPC,   ________WIN_THUMB_R______,  KC_1,    KC_2,   KC_GAMER
    ),

    //1st Game Layer
    [_GAMER] = LAYOUT_wrapper(
      KC_ESC,    KC_T,    KC_Q,    KC_W,    KC_E,    KC_R,     _______,    _________________QWERTY_R1_________________,            KC_BSPC,
      KC_TAB,    KC_G,    KC_A,    KC_S,    KC_D,    KC_F,                 _________________QWERTY_R2_________________,            KC_ENT,
      KC_ENT,    KC_B,    KC_Z,    KC_X,    KC_C,    KC_V,                 KC_N,    KC_M,    KC_COMM, KC_DOT,   LT(_MDIA,KC_SLSH), KC_QUOT,
      KC_F3,     KC_F5,   KC_LCTL, KC_LALT, KC_LSFT, KC_SPC,   MO(_GAMR1),  KC_F3,   KC_F2,   _______, _______,  _______,           KC_WINBASE
    ),
    ...
    [_SYMB] = LAYOUT_wrapper(
      ...
      UG_NEXT, _________________PUNC_L3_ALT_______________,              _________________PUNC_R3___________________, _______,
      _______, _______, KC_NUM,  KC_LSCR, KC_DEL,  _______,    _______,  _______, KC_CAPS, KC_SCT1, _______, _______, _______
    ),
    ...
    [_FUNC] = LAYOUT_wrapper(
      ...
      UG_NEXT, _____________FUNC_L3_______________________,              _______, _____________FUNC_3_______________, _______,
    ...
    [_MNMB] = LAYOUT_wrapper(
      ...
      UG_NEXT, _________________MACNAV_L3_________________,              _________________NUMB_R3_MAC_______________, _______,
    ...
    [_NUMB] = LAYOUT_wrapper(
      ...
      UG_NEXT, _________________WINNAV_L3_________________,              _________________NUMB_R3_WIN_______________, _______,
      _______, _______, _______, TO(_WINBASE), _______, _______,    _______,  _______, RSFT_T(KC_ENT), KC_RSFT, KC_NUM, _______, _______
    ),

    [_MDIA] = LAYOUT_wrapper(
      _______, _________________LYOUT_____________________,    _______,  _________________RGB_1_____________________, UG_TOGG,
      _______, MU_TOGG, _______, _______, _______,   CK_UP,              _________________RGB_2_____________________, _______,
      UG_NEXT, MU_NEXT, MU_TOGG,  CK_TOGG, CK_RST, CK_DOWN,              _________________MEDIA_____________________, _______,
