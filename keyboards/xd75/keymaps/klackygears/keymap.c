...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMER] = LAYOUT_wrapper( \
    ...
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     KC_MINS, KC_PLUS, KC_QUES,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
    KC_TAB,  _________________QWERTY_L1_________________,  KC_7, KC_8, KC_9, _________________QWERTY_R1_________________, KC_BSPC,
    KC_CAPS, _________________QWERTY_L2_________________,  KC_4, KC_5, KC_6,   _________________QWERTY_R2_________________, KC_ENT,
    KC_LSFT, _________________QWERTY_L3_________________,  KC_1, KC_2, KC_3,   _________________QWERTY_R3_________________, KC_RSFT,
    KC_LCTL, KC_LALT, KC_LGUI, KC_LCTL, MT(MOD_LSFT,KC_SPC),  KC_SPC, KC_LEFT, KC_0, KC_RGHT, KC_SPC, MO(_SYMB), MO(_MNMB), KC_RGUI, MO(_MDIA), MO(_FUNC)
  ),
