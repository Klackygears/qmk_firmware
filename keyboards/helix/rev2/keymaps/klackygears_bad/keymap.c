...
*/
  ...
  [_DVRK] = LAYOUT( \
      ...
      MO(_SYMB),  KC_ESC,  KC_LALT, KC_LGUI, KC_A,    KC_A,   KC_SPC,  KC_SPC,  KC_A,   KC_A,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),

  [_SYMB] = LAYOUT( \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
      KC_ACCW, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
