...
#define L_GAMER (1<<_GAMER)
#define L_GAMR1 (1<<_GAMR1)
#define L_GAMR2 (1<<_GAMR2)
#define L_GAMER_TRI (L_GAMER|L_GAMR2|L_BASE)
#define L_GAMR1_TRI (L_GAMR1|L_GAMER|L_BASE)
#define L_GAMR2_TRI (L_GAMR2|L_GAMR1|L_BASE)
...
#    endif
  // Define layers here, Have not worked out how to have text displayed for each layer. Copy down the number you see and add a case for it below
    ...
    case L_BASE:
        ...
        break;
    case L_NUMB:
        oled_write_P(keeb_face[1], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(PSTR(" "), false);
        oled_write_P(sm_logo[0][0], false);
        oled_write_P(PSTR("\n"), false);
        ...
        break;
    case L_MNMB:
        oled_write_P(keeb_face[2], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(PSTR(" "), false);
        oled_write_P(sm_logo[0][0], false);
        oled_write_P(PSTR(" "), false);
    ...
    case L_SYMB:
        ...
        break;
    case L_FUNC:
        oled_write_P(keeb_face[4], false);
        oled_write_P(PSTR("\n"), false);
    ...
    case L_GAMER_TRI:
        oled_write_P(keeb_face[1], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(sm_logo[2][0], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(sm_logo[2][1], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(PSTR("\n"), false);
        break;
    ...
    case L_GAMR2_TRI:
        oled_write_P(keeb_face[5], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(sm_logo[3][0], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(sm_logo[3][1], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(PSTR("\n"), false);
        break;
