...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WINBASE] = LAYOUT_wrapper(
      ...
      KC_1,     KC_2,    KC_3,   ________WIN_THUMB_L______,   KC_SPC,  KC_SPC, ________WIN_THUMB_R______, KC_1,     TG(_GAMR1), TG(_GAMER)
    ),
    ...
    [_GAMER] = LAYOUT_wrapper(
      ...
      KC_TAB,      KC_R,    KC_G,    KC_W,    KC_E,    KC_1,                     KC_T,    KC_Z,    _______, _______, KC_UP,    KC_WINBASE,
      OSL(_GAMR2), KC_V,    KC_A,    KC_S,    KC_D,    KC_2,                     KC_P,    KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN,  KC_RIGHT,
      KC_C,        KC_I,    KC_F,    KC_Q,    KC_4,    KC_3,   _______, _______, _________________MEDIA_____________________,  _______,
      KC_Z,        KC_X,    KC_C,    KC_LCTL, KC_LSFT, KC_SPC, KC_F3,   KC_F5,   KC_Q,   KC_C,     KC_B,    KC_ENT,  _______,  _______
    ),

    //Basic WASD Game Layer
    [_GAMR1] = LAYOUT_wrapper(
      ...
      MO(_GAMR2), _________________QWERTY_L2_________________,                    _________________QWERTY_R2_________________, KC_ENT,
      KC_LSFT,    _________________QWERTY_L3_________________,   KC_F12,  KC_F10, _________________QWERTY_R3_________________, KC_RSFT,
      KC_LCTL,    KC_N,   KC_V,     KC_LALT,  KC_LCTL,  KC_LSFT, KC_SPC,  KC_F1,  _______, _______, _______, KC_ENT,  _______, KC_SPC
    ),

    //2
    [_GAMR2] = LAYOUT_wrapper(
      KC_ESC,  _________________FUNC_LEFT_________________,                     _________________FUNC_RIGHT________________, KC_WINBASE,
      KC_R,    _________________NUMB_R1_Game______________,                     KC_T,    KC_Z,    _______, _______, KC_UP,   KC_WINBASE,
      _______, _________________NUMB_R2_Game______________,                     KC_P,    KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN, KC_RIGHT,
    ...
    [_SYMB] = LAYOUT_wrapper(
      ...
      _______, _________________PUNC_L1_ALT_______________,                   _________________PUNC_R1___________________, SPAM,
