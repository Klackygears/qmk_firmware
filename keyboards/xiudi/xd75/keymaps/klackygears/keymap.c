...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WINBASE] = LAYOUT_wrapper(
    _______, _______, _______, KC_ESC,  _________________NUMBER_L__________________, _________________NUMBER_R__________________, KC_BSPC,
  ...
  [_GAMER] = LAYOUT_wrapper(
    KC_NUM,  KC_F3,   KC_F5,   KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,              KC_BSPC,
    KC_P7,   KC_P8,   KC_P9,   KC_GRV,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,              KC_QUOT,
    KC_P4,   KC_P5,   KC_P6,   KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,           KC_ENT,
    KC_P1,   KC_P2,   KC_P3,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  LT(_MDIA,KC_SLSH), KC_RSFT,
    KC_P0,   KC_PDOT, KC_PENT, _______, KC_LCTL, KC_LALT, KC_LSFT, KC_SPC,  KC_SPC,  KC_SPC,  KC_LSFT, KC_LALT, KC_RCTL, _______,           _______
  ),
  ...
  [_GAMR2] = LAYOUT_wrapper(
    _______, _______, _______, KC_ESC,  _________________NUMBER_L__________________, _________________NUMBER_R__________________, _______,
    _______, _______, _______, _________________NUMB_R1_Game______________, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _________________NUMB_R2_Game______________, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _________________NUMB_R3_Game______________, KC_H,    KC_L,    _______, _______, _______, _______, _______,
    _______, _______, _______, KC_X,    KC_C,    KC_LCTL, KC_LSFT,  KC_SPC, KC_F3,   KC_F5,   _______, _______, _______, _______, _______
  ),
