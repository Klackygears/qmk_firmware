...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMER] = LAYOUT_wrapper(
    ...
    KC_0,    KC_F1,   KC_F2,   KC_F3,   KC_LSFT, KC_LCTL, KC_LALT, KC_SPC,  KC_F3,   KC_SPC,  KC_LSFT, KC_LALT, KC_RCTL, _______, _______
  ),
  ...
  [_GAMR1] = LAYOUT_wrapper(
    ...
    KC_0,    KC_F1,   KC_F2,   KC_F3,   KC_LCTL, KC_LALT, KC_LSFT, KC_SPC,  KC_SPC,  KC_SPC,  KC_LSFT, KC_LALT, KC_RCTL, _______,           _______
  ),
